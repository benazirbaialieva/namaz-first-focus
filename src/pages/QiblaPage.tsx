    ...
    <div className="min-h-screen bg-deep pb-24 px-4 pt-6" dir={rtl ? "rtl" : "ltr"}>
      ...
      <div className="flex flex-col items-center">
        <div className={`relative w-72 h-72 rounded-full glass-card flex items-center justify-center transition-all duration-500 ${isAligned ? "ring-4 ring-sajda/30" : ""}`}
          ...
          <motion.div className="absolute w-full h-full" animate={{ rotate: needleRotation }}
            ...
            <div className="absolute left-1/2 top-4 -translate-x-1/2"><div className="w-3 h-3 rotate-45 bg-gold" /></div>
          </motion.div>
